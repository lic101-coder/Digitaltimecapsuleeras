...
/**
 * Parses a date string from an HTML date input in LOCAL time
 * @param dateString - Date string from input (e.g., "2024-05-19")
 * @returns Date object in local timezone, or undefined if invalid
 *
 * CRITICAL: HTML date inputs return strings like "2024-05-19"
 * new Date("2024-05-19") interprets this as midnight UTC, NOT local time
 * This function parses it correctly as midnight in the user's local timezone
 */
export function parseDateInputAsLocal(dateString: string): Date | undefined {
