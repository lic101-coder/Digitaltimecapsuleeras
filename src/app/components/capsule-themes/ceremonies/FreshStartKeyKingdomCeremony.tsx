...
export function FreshStartKeyKingdomCeremony({
  ...
  useEffect(() => {
    ...
    fireConfetti({ ...opts, particleCount: count / 2, angle: 60, spread: 75, origin: { x: isMobile ? 0.12 : 0, y: 0.55 } });
    fireConfetti({ ...opts, particleCount: count / 2, angle: 120, spread: 75, origin: { x: isMobile ? 0.88 : 1, y: 0.55 } });
    if (!isMobile) {
