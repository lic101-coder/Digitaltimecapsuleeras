 ...
 * 
 * Duration: 14 seconds (MUCH FASTER!)
 * Stages:
 * 1. 0-1s: Intro with lobby
 * 2. 1-2s: Elevator doors closing FAST
 * 3. 2-6s: RAPID ascent with floor counter (4 seconds only!)
 * 4. 6-8s: Building exterior QUICK view
 * 5. 8-10s: Doors opening, office reveal
 * 6. 10-14s: Radiance finale with office burst
 */
