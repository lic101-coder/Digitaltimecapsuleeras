 ...
 * Stages:
 * 1. 0-2s: Cosmic clock materializes with Roman numerals and ornate details
 * 2. 2-4s: Internal gears become visible, spinning with mechanical precision
 * 3. 4-6s: Clock hands accelerate wildly, time flowing faster
 ...
 * 6. 11-13s: Shards form constellation of temporal nodes
