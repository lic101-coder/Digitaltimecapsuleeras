 ...
 * Stages:
 * 1. 0-1s: Intro
 * 2. 1-4s: Chrysalis hangs peacefully, subtle glow begins within
 * 3. 4-7s: Cracks form with golden light, chrysalis splits open
 * 4. 7-10s: Butterfly STRUGGLES out slowly, wings wet and crumpled
 * 5. 10-12s: Wings unfold and dry, then graceful flight upward
 * 6. 12-16s: Radiance finale
 */
