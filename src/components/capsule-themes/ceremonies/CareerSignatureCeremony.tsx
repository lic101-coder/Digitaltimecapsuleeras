 ...
 * Stages:
 * 1. 0-1s: Intro
 * 2. 1-4s: Hall materializing, portraits appearing on walls
 * 3. 4-6s: Red carpet rolling out toward viewer
 * 4. 6-9s: Walking forward (camera push), flash photography
 * 5. 9-12s: Arriving at YOUR portrait being unveiled
 * 6. 12-14s: Golden frame glowing, nameplate appearing
 * 7. 14-16s: Radiance finale
 */
