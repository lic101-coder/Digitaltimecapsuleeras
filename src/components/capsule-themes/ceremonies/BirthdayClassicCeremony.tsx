 ...
 * Duration: 14 seconds
 * Stages:
 * 1. 0-2s: Birthday cake appears with lit candles
 * 2. 2-4s: Candles flicker and dance
 * 3. 4-6s: Wind builds up (breath)
 * 4. 6-8s: Candles blow out with wind effect
 * 5. 8-10s: Smoke trails rise and swirl
 * 6. 10-14s: EXPLOSIVE radiance transformation
 */
