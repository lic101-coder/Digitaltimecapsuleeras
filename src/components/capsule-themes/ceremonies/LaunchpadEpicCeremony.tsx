 ...
 * Stages:
 * 1. 0-1s: Intro
 * 2. 1-3s: Countdown with engine ignition
 * 3. 3-6s: Liftoff with massive engine plume
 * 4. 6-9s: Ascent through atmosphere layers
 * 5. 9-12s: Break through to space with stars appearing
 * 6. 12-14s: Spiral trail to nebula destination
 * 7. 14-17s: Radiance finale
 */
            ...
            {[...Array(100)].map((_, i) => (
              <motion.div
                ...
                transition={{
                  duration: 1.5,
                  delay: i * 0.01,
                  repeat: stage === 'destination' || stage === 'radiance' ? Infinity : 0,
