 ...
 * Duration: 18 seconds
 * Stages:
 * 1. 0-2s: Digital grid and scanning lines materialize
 * 2. 2-4s: Data streams cascade downward in Matrix style
 * 3. 4-7s: Holographic upload terminal appears with progress indicators
