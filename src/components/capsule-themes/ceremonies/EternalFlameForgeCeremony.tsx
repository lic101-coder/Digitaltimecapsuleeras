 ...
 * Duration: 18 seconds
 * Stages:
 * 1. 0-2s: Dark forge intro - dormant
 * 2. 2-4s: Bellows pump - coals ignite white-hot
 * 3. 4-6s: Two molten hearts placed on anvil
 * 4. 6-11s: Hammer strikes - 5 powerful blows with sparks
 * 5. 11-12.5s: Hearts fuse - molten flow together
 * 6. 12.5-14.5s: Quench - water steam EXPLOSION
 * 7. 14.5-16s: Perfect heart revealed
 * 8. 16-18s: Forge supernova radiance finale
 */
