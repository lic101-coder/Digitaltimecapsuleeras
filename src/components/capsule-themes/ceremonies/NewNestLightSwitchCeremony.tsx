 ...
 * Duration: 13 seconds
 * Stages:
 * 1. 0-1s: Darkness with anticipation
 * 2. 1-3s: Hand reaches, first switch - Living Room
 * 3. 3-5s: Second switch - Kitchen
 * 4. 5-7s: Third switch - Bedroom
 * 5. 7-9s: Fourth switch - Entire house exterior
 * 6. 9-11s: All windows glow
 * 7. 11-13s: Epic radiance finale
 */
