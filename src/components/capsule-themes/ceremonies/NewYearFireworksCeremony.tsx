 ...
 * Duration: 16 seconds
 * Stages:
 * 1. 0-1s: Dark sky anticipation
 * 2. 1-3s: First rockets launch
 * 3. 3-6s: Wave 1 - Colorful chrysanthemums
 * 4. 6-9s: Wave 2 - Willows and palms
 * 5. 9-12s: Wave 3 - Multiple rapid bursts
 * 6. 12-14s: Grand Finale - "2026" forms
 * 7. 14-16s: Epic radiance with all colors
 */
