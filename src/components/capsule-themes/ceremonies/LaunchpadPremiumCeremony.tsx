 ...
 * Stages:
 * 1. 0-1s: Intro
 * 2. 1-4s: Dark storm clouds gather with rolling motion
 * 3. 4-7s: Multiple REALISTIC lightning bolts strike from ALL ANGLES
 * 4. 7-9s: Lightning energy flows INTO center sphere - sphere GROWS and PULSES
 * 5. 9-11s: SPHERE COLLAPSES then EXPLODES - massive shockwave bursts outward
 * 6. 11-14s: Radiance finale
 */
