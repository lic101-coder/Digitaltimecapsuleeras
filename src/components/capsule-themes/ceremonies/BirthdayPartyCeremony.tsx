 ...
 * Duration: 13 seconds
 * Stages:
 * 1. 0-2s: First balloons float up from bottom
 * 2. 2-4s: More balloons rise and join
 * 3. 4-7s: Balloons bounce and sway together
 * 4. 7-9s: Balloons start popping with sparkles
 * 5. 9-13s: EXPLOSIVE radiance finale
 */
