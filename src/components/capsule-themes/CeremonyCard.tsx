  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Duration badge - FORCE VISIBLE WITH MORE SPACING */}
        <div 
          style={{ 
            position: 'relative',
            zIndex: 20,
          ...
          className="px-2 py-0.5 md:px-5 md:py-2.5"  // DESKTOP: Much bigger padding
        >
          <span 
            style={{ 
              opacity: 1,
            ...
            className="text-[8.5px] md:text-xl"  // Mobile: 8.5px, DESKTOP: 20px (150% increase)
          >
            {ceremony.duration}s
          </span>
        </div>
