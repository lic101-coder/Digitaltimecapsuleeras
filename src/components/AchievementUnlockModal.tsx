...
export function AchievementUnlockModal({ 
  ...
  const [phase, setPhase] = useState<'trigger' | 'reveal' | 'context' | 'complete'>('trigger');
  ...
  useEffect(() => {
    if (isOpen && achievement && !prefersReducedMotion) {
      ...
      const existingCanvas = document.getElementById('achievement-confetti-canvas');
      if (existingCanvas) {
  ...
  const shareText = achievement.shareText || 
  ...
  const handleClose = () => {
    ...
    if (!achievement?.id) {
      console.warn('⚠️ [AU Modal] No achievement to close, skipping event dispatch');
      return;
    }
    ...
    console.log('📡 [AU Modal] Dispatching achievementClosed event:', eventDetail);
            ...
            >
              ...
              >
                ...
                <div className="relative px-6 py-4 md:py-8">
                  ...
                  {/* Trophy on Pedestal */}
                  <div className="relative flex flex-col items-center" style={{ minHeight: isMobile ? '200px' : '280px' }}>
                    {/* Trophy */}
                    <motion.div
                      ...
                      transition={{ 
                        y: { delay: 0.6, duration: 0.8, ease: [0.34, 1.56, 0.64, 1] },
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          background: achievement.visual?.gradientStart && achievement.visual?.gradientEnd
                    ...
                    >
                      ...
                      <div 
                        ...
                        style={{
                          background: 'linear-gradient(to bottom, #8b5a3c 0%, #6b4423 100%)',
                      ...
                      <div 
                        ...
                        style={{
                          background: 'linear-gradient(to bottom, #6b4423 0%, #5a3618 100%)',
                      ...
                      <div 
                        ...
                        style={{
                          background: 'linear-gradient(to bottom, #6b4423 0%, #4a2f15 100%)',
                    ...
                    <motion.div
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: phase === 'context' || phase === 'complete' ? 1 : 0, y: 0 }}
                      transition={{ delay: 2.2, duration: 0.5 }}
                      className="relative mt-1 md:mt-2 px-3 md:px-4 py-1.5 md:py-2 rounded-md"
                      style={{
                        background: 'linear-gradient(135deg, #d4af37 0%, #a88734 50%, #d4af37 100%)',
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className={`${isMobile ? 'text-xs' : 'text-base'} font-serif font-bold text-black`}>
                          {achievement.title}
                        </div>
                      </div>
                ...
                >
                  ...
                  <motion.div
                    ...
                    animate={{ opacity: phase === 'context' || phase === 'complete' ? 1 : 0, scale: 1 }}
                  ...
                  <AnimatePresence>
                    {showShareMenu && (
                      ...
                      >
                        <p className="text-xs text-white/60 mb-3 text-center">Share your achievement:</p>
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 3.2, duration: 0.4, ease: [0.34, 1.56, 0.64, 1] }}
...
function getRarityConfig(rarity: string) {
  const configs = {
    common: {
      ...
      trophyGradient: 'radial-gradient(circle at 35% 35%, #e2e8f0 0%, #cbd5e1 50%, #94a3b8 100%)',
      badgeGradient: 'linear-gradient(135deg, #cbd5e1 0%, #94a3b8 100%)',
      glowColor: 'rgba(148, 163, 184, 0.4)',
      spotlights: [
        { position: '50%', color: 'rgba(255, 255, 255, 0.3)' }
      ]
    },
    uncommon: {
      velvetColor: 'linear-gradient(to bottom, #0f766e 0%, #134e4a 100%)', // Teal velvet
      trophyGradient: 'radial-gradient(circle at 35% 35%, #ccfbf1 0%, #5eead4 50%, #14b8a6 100%)',
    ...
    rare: {
      ...
      trophyGradient: 'radial-gradient(circle at 35% 35%, #e9d5ff 0%, #c084fc 50%, #9333ea 100%)',
    ...
    epic: {
      ...
      trophyGradient: 'radial-gradient(circle at 35% 35%, #fef3c7 0%, #fbbf24 50%, #f59e0b 100%)',
    ...
    legendary: {
      velvetColor: 'linear-gradient(135deg, #1e1b4b 0%, #581c87 25%, #831843 50%, #be123c 75%, #7c2d12 100%)', // Rainbow velvet
      trophyGradient: 'radial-gradient(circle at 35% 35%, #ffffff 0%, #fbbf24 25%, #f472b6 50%, #a78bfa 75%, #06b6d4 100%)',
      badgeGradient: 'linear-gradient(135deg, #fbbf24 0%, #f472b6 50%, #a78bfa 100%)',
